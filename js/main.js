...
function render() {
    for (let i = 0; i < boxes.length /*here you can use 9 if you want, but thats hardcoding*/; i++) {
        //lets find which color we want it to set
        let curentColor  = colors[board[i]];
        // console.log(curentColor); //checked it works
        boxes[i].style.backgroundColor = curentColor;
        // console.log('index of: ' + i, boxes[i].style.backgroundColor)
    }
    if (winner === null) {
